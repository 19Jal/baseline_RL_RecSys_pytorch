...
def warm_train(file, test_num, warm_split, k):
    """Train model in warm-start setting with memory"""
    ...
    # Initialize model
    im = EMInteractiveModel(rnn_size, layer_size, item_size, embedding_dim, k, lr, device)
    im.to(device)
    ...
    for epoch in range(nb_epoch):
        ...
        for j, user in enumerate(train_users):
            ...
            while end_slice <= overall_length and start_slice < overall_length:
                ...
                if epoch > switch_epoch:
                    ...
                    loss, rein, train_hit, final_state, masking, samples = im.reinforcement_learn(
        ...
        for user in test_users:
            ...
            # Run inference
            (user_item_probs, samples, user_final_masking, 
            ...
            user_selected_items_pred = np.reshape(samples, (inference_length,))
        ...
        if (epoch + 1) % 10 == 0:
            ...
            }, f'warm_checkpoint_{file}_{test_num}_{epoch}.pt')
...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        warm_split = 0.5  # Changed from 0.0 to match the warm_splits variable
